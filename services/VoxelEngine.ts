...
export class VoxelEngine {
  ...
  constructor(
    ...
    // Enhanced tone mapping for more realistic lighting
    ...
    const dirLight = new THREE.DirectionalLight(0xfff0dd, 1.8); // Warm sunlight
    ...
    // Rim/Fill Light (Cool backlight for separation)
  ...
  private createVoxels(data: VoxelData[]) {
    ...
    // Slightly smoother material for a "toy plastic" look
